...
import jodychatbot.org.alicebot.server.net.listener.AliceChatListener;
import jodychatbot.org.alicebot.server.net.listener.AliceChatListenerRegistry;
        ...
        throws InvalidStartupElementException
    {
        ...
        try
        {
            alicechatlistener = (AliceChatListener)class1.getConstructor(new Class[] {
                jodychatbot.org.alicebot.server.core.Bot.class
